...
import so.dang.cool.httpclient.internal.rule.Rule;
...
public class DebuggerTest {
    ...
    void should_print_all_request_with_no_matching_rules() throws Exception {
        ...
        try {
            httpClientMock.send(TestRequests.get("http://localhost/login"), discarding());
    ...
    void should_put_message_about_matching_URL() {
        ...
        assertThrows(NoMatchingRuleException.class, () -> httpClientMock.send(TestRequests.post("http://localhost:8080/login"), discarding()));
